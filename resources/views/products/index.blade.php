                ...
                @if (count($products) > 0 )
                    @foreach ($products as $product )
                            ...
                            <div style="display: flex">     
                                <a href="{{ route('products.edit',$product->id) }}" class="btn btn-link btn-success" style="padding-top:4px; padding-bottom:4px">
                                ...
                                <form method="post" action="{{ route('products.destroy',$product->id)  }}">
                                    ...
                                    <button class="btn btn-link btn-danger" onclick="deleteConfirm(event)" >
