        ...
        <form action="{{ route('products.update',$product->id) }}" enctype="multipart/form-data" method="post">
            ...
            <div class="card">
                <div>
                    ...
                    <img src="{{ asset('image/'.$product->image) }}" alt="" class="img-product" id="file_preview">
                ...
                <div>
                    ...
                    <select name="category" id="">
                        @foreach ( json_decode('{ "Smartphone":"Smartphone","Smart TV":"Smart TV", "Computer":"Computer","Watch":"Watch"}', true) as $optionKey => $optionValue )
